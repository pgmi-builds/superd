...
import { writeFileSync, mkdirSync, existsSync, symlinkSync, rmSync } from 'node:fs'
...
const routing = await import('/home/u1/workspaces/superd/super-dsh/agent-hub/dist/index.js')
const wanted = ['omp', 'codex', 'claude']
const ready = {}
for (let i = 0; i < 240; i++) {
